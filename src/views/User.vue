<template>
  <main role="main">
    <div class="album py-5 bg-light">
      <div class="container">
        <UserProfileCard :profile="profile" :is-followed="isFollowed"/>
        
        <div class="row">
          <div class="col-md-4">
            <UserFollowingsCard :following="profile.Followings"/>
            <br>
          ...
          <div class="col-md-8">
            ...
            <br>
            <UserFavoritedRestaurantCard :favorited-restaurants="profile.FavoritedRestaurants"/>
          </div>
        </div>
      </div>
    </div>
